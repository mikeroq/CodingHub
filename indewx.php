...
$sql = new mysqld();
$sql->connect("localhost","root","kelly11","codinghub_site"); 
...
<?php
				...
				?>
<title>TutorialHub - <?=$title?></title>				<!-- mikeroq@gmail.com -->
...
<div id='hold'>
	<div id='head_unit'>
		<div id="logo">
			<a href='/'><img src="/images/logo.png" alt="tutorialhub" style='border: 0;' /></a>
		</div> 
	</div>
	<div class='nav' style='border-left: 0px; border-right: 0px;'>
	<a href='/'>Home</a>&nbsp;&nbsp;<a href='/affiliates/'>Affiliates</a>&nbsp;&nbsp;<a href='/stats/'>Stats</a>&nbsp;&nbsp;<a href='/contact/'>Contact</a>
	</div>
	<div id='main'>		  
		<div id='left'>
		 <!--
		...
		<?
		$timeout = ($now-$timeout);
	  	$getusers = mysql_query("SELECT * FROM `members` WHERE time>='$timeout'");
		...
		echo "<h2>Online</h2><div class='box'>";
	   	if($numusers == 0)
			...
			$total = $numguest + $i;
	  	echo "<br />Guests: $numguest, Members online: $i, Total: $total</div>";
	  	?>
		</div>
		<div id='right'>
